    ...
    return (            
        <div className="w-full bg-[url(@/../public/static/hero_bg.png)] bg-cover bg-center bg-no-repeat">
            <Container className="py-40 md:py-52 text-black flex flex-col gap-24 w-full px-5 xl:px-0">
                <h1 className="text-2xl  sm:text-3xl md:text-6xl text-white font-bold"> Высоконагрузочные <span className="text-blue-400">решения</span> для <span className="text-blue-300">амбициозного роста</span></h1>
